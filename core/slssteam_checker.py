...
class SlssteamChecker:
    ...
    def _check_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if (isinstance(play_not_owned, str) and play_not_owned.lower() == "yes") or play_not_owned is True:
                result["play_not_owned_games"] = True
                result["details"]["config_valid"] = True
                result["valid"] = True
            else:
                result["details"]["error_message"] = f"PlayNotOwnedGames is '{play_not_owned}', must be 'yes'"
    ...
    def get_status_message(self, status: SlssteamStatus, details: Dict[str, Any]) -> str:
    ...
    def get_status_description(self, status: SlssteamStatus, details: Dict[str, Any]) -> str:
        ...
        if status == SlssteamStatus.NOT_INSTALLED:
            ...
            if details.get("config_exists") and not details.get("config_valid"):
                ...
                return f"Configuration file not found or invalid."
